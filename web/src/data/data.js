...
const data = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          {
            name: "Сортируйте макулатуру по видам",
            description:
              "Например, тетради складывайте в одну стопку, офисную бумагу и черновики - в другую, а газеты - в третью. Вам так будет проще сдавать, и дальше будет легче сортировать и перерабатывать",
          },
          {
            name: "Проверьте, что макулатура сухая",
            description: "",
          },
          {
            name: "Вытащите скрепки, скобки, пружины",
            description: "",
          },
          {
            name: "Проверьте, что нет ламинации",
            description: "",
          },
          {
            name: "Убедитесь, что нет пластиковых элементов",
            description: "К ним относятся пленки, файлы",
          },
          {
            name: "Перевяжите макулатуру и сплющьте коробки",
            description: "",
          },
        ],
      },
    ...
    sections: [
      {
        ...
        content: [
          ...
          {
            name: "Листовое (оконное) стекло (не везде)",
            icon: <WindowIcon />,
          },
        ],
      },
      ...
      },
      {
        ...
        content: [
          {
            name: "Снимите бумажные и термоусадочные этикетки, свинтите крышки и вытащите пробки",
            description: "",
          },
          {
            name: "Ополосните стеклотару",
            description: "",
          },
          {
            name: "Высушите",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          {
            name: "Снимите этикетки",
            description: "",
          },
          {
            name: "Ополосните от остатков пищи",
            description: "",
          },
          {
            name: "Высушите",
          ...
          {
            name: "Уменьшите в объеме, если возможно",
            description: "",
          },
        ],
      },
  ...
  },
  {
    ...
    sections: [
...

      {
        ...
        content: [
          {
            name: "Снимите с изделия все бумажные и термоусадочные этикетки, крышки",
            description:
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          {
            name: "Отогните все уголочки на коробке",
            description:
              "Если это пакет, то надрежьте его верхнюю часть, чтобы можно было ополоснуть",
          },
          {
            name: "Ополосните коробку или пакет",
            description: "",
          },
          {
            name: "Высушите",
          ...
          {
            name: "Сплющьте коробку и завинтите крышку, сложите пакет",
            description: "",
          },
        ],
      },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          {
            name: "Разделите опасные отходы по видам",
            description: "",
          },
        ],
      },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          {
            name: "Проверьте, что батарейка не повреждена",
            description: "",
          },
          {
            name: "Складывайте все батарейки в отдельный контейнер",
            description: "",
          },
          {
            name: "Сдайте в специальный пункт приема",
            description: "",
          },
        ],
      },
  ...
  // },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          {
            name: "Определите качество одежды: можно носить или нет? ",
            description:
          ...
          {
            name: "Если одежду уже невозможно носить, сдайте на переработку",
            description:
              "О возможностях переработки уточняйте в конкретных пунктах приема",
          },
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          {
            name: "Проверьте, что лампа целая",
            description:
              "Если она разбилась — ничего страшного, ее тоже можно утилизировать",
          },
          {
            name: "Складывайте лампы в отдельный контейнер",
            description:
              "Можете обернуть тканью, чтобы они не разбились. Ртутные (люминесцентные) лампы стоит упаковать в герметичный пластиковый пакет",
          },
          {
            name: "Сдайте в специальный пункт приема",
            description: "",
